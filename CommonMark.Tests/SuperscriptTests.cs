...
namespace CommonMark.Tests
{
    ...
    public class SuperscriptTests
    {
        ...
        [TestMethod]
        [TestCategory("Inlines - Superscript")]
        public void SuperscriptDisabledInPost()
        {
        ...
        [TestMethod]
        [TestCategory("Inlines - Superscript")]
        public void SuperscriptUnescapedLeadingSpace()
        {
        ...
        [TestMethod]
        [TestCategory("Inlines - Superscript")]
        public void SuperscriptUnescapedTrailingSpace()
        {
            Helpers.ExecuteTest("foo ^bar ^", "<p>foo ^bar ^</p>", Settings);
        }
        ...
        [TestMethod]
        [TestCategory("Inlines - Superscript")]
        public void SuperscriptUnescapedLeadingAndTrailingSpaces()
        {
            Helpers.ExecuteTest("foo ^ bar ^", "<p>foo ^ bar ^</p>", Settings);
        }
        ...
        //[TestMethod]
        [TestCategory("Inlines - Superscript")]
        public void SuperscriptUnescapedInnerSpace()
        {
            Helpers.ExecuteTest("^foo bar^", "<p>^foo bar^</p>", Settings);
        }
    }
