...
namespace CommonMark.Tests
{
    ...
    public class SubscriptTests
    {
        ...
        [TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptDisabledInPost()
        {
        ...
        [TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptWithStrikeoutInPost()
        {
            // '[' char in the middle will delay the ~~ match to the post-process phase.
            var s = CommonMarkSettings.Default.Clone();
            s.Extensions.Register(new Extension.Subscript(s));
        ...
        [TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptUnescapedLeadingSpace()
        {
        ...
        [TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptUnescapedTrailingSpace()
        {
            Helpers.ExecuteTest("foo ~bar ~", "<p>foo ~bar ~</p>", Settings);
        }
        ...
        [TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptUnescapedLeadingAndTrailingSpaces()
        {
            Helpers.ExecuteTest("foo ~ bar ~", "<p>foo ~ bar ~</p>", Settings);
        }
        ...
        //[TestMethod]
        [TestCategory("Inlines - Subscript")]
        public void SubscriptUnescapedInnerSpace()
        {
            Helpers.ExecuteTest("~foo bar~", "<p>~foo bar~</p>", Settings);
        }
    }
