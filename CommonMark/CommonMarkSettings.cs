...
#pragma warning restore 0618
        ...
        private Func<Syntax.Block, Parser.Subject, CommonMarkSettings, Syntax.Inline>[] _inlineParsers;

        /// <summary>
        /// Gets the delegates that parse inline elements according to these settings.
        /// </summary>
        internal Func<Syntax.Block, Parser.Subject, CommonMarkSettings, Syntax.Inline>[] InlineParsers
        {
            get
            {
