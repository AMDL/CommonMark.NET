...
namespace CommonMark.Parser
{
    ...
    class BlockParserParameters
    {
        ...
        {
            var customContainers = 0 != (settings.AdditionalFeatures & CommonMarkAdditionalFeatures.CustomContainers);
            var fenceDelimeters = customContainers ? new char[3] : new char[2];
            fenceDelimeters[0] = '`';
            fenceDelimeters[1] = '~';
            if (customContainers)
                fenceDelimeters[2] = ':';
