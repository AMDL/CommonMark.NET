namespace CommonMark.Parser
{
    ...
    public abstract class InlineDelimiterHandler : IInlineDelimiterHandler
    {
        ...
        public virtual bool Handle(Subject subject, int delimiterCount, int startIndex, int length, bool beforeIsPunctuation, bool afterIsPunctuation, ref bool canOpen, ref bool canClose)
        {
            return false;
        }
    }
